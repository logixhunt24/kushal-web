...
export default function AboutSection() {
  return (
    <section
      ...
      style={{ backgroundColor: 'var(--kushal-white3)', paddingTop: 'var(--section-space)', paddingBottom: 'var(--section-space)' }}
    >
      ...
      <div className="relative z-10 mx-auto px-4 sm:px-6 lg:px-8" style={{ maxWidth: 'var(--container-width)' }}>
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              <div
                ...
                style={{ backgroundColor: 'rgba(var(--kushal-base-rgb), 0.12)', color: 'var(--kushal-base)' }}
              >
                <ShieldCheck size={18} />
              </div>
              <div>
                <p className="text-sm font-black leading-none" style={{ color: 'var(--kushal-heading)' }}>10K+</p>
                <p className="text-[10px] font-bold uppercase tracking-wider" style={{ color: 'var(--kushal-text)' }}>Happy clients</p>
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            <span
              ...
              style={{ backgroundColor: 'rgba(var(--kushal-base-rgb), 0.1)', color: 'var(--kushal-base)' }}
            >
              <Sparkles size={14} /> Our Story
            </span>

            <h2 className="text-4xl sm:text-5xl md:text-6xl font-black leading-tight" style={{ color: 'var(--kushal-heading)' }}>
              Built for{' '}
              <span style={{ color: 'var(--kushal-base)', fontFamily: 'var(--kushal-script-font)' }}>Service</span>,{' '}
              <br className="hidden sm:block" />
              Designed for{' '}
              <span style={{ color: 'var(--kushal-base)', fontFamily: 'var(--kushal-script-font)' }}>People</span>
            </h2>

            <p className="text-base sm:text-lg leading-relaxed font-medium max-w-2xl" style={{ color: 'var(--kushal-text)' }}>
              KushalApp was born out of a simple necessity: to remove the friction between high-quality
              service providers and the people who need them. We believe in transparency, speed, and
              building a community where trust is the primary currency.
            </p>
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              {features.map((feature, i) => (
                ...
                >
                  ...
                  <h4 className="font-black text-sm sm:text-base mb-1" style={{ color: 'var(--kushal-heading)' }}>
                    {feature.title}
                  </h4>
                  <p className="text-xs sm:text-sm leading-relaxed" style={{ color: 'var(--kushal-text)' }}>
                    {feature.desc}
                  </p>
                </motion.div>
              ))}
