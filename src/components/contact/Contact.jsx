...
export default function SupportContact() {
  return (
    <section
      className="py-24 px-6 relative w-full"
    ...
    >
      <div className="max-w-[var(--container-width)] mx-auto">
        ...
        >
          ...
          >
            <span
              className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-[0.2em] mb-8 border w-fit"
              style={{
                borderColor: "rgba(var(--kushal-base-rgb), 0.2)",
            ...
            <p className="text-gray-500 font-medium mb-10 leading-relaxed max-w-md">
              Whether you're booking a service, managing your provider account,
              or have a business inquiry — our team is ready to assist you.
              Reach out and we’ll get back to you as soon as possible.
            </p>

            <motion.div
              whileHover={{ x: 5 }}
              className="flex items-center gap-3 font-bold text-sm cursor-pointer"
              style={{ color: "var(--kushal-heading)" }}
            >
              <Mail size={20} className="text-[var(--kushal-base)]" />{" "}
          ...
          >
            <form className="space-y-5">
              {[
                ...
                <div key={i}>
                  <label className="block text-xs font-bold text-white/80 mb-2 uppercase tracking-widest">
                    {label}
                  </label>
                  {label === "This inquiry is regarding" ? (
                    ...
                    <input
                      type="text"
                      className="w-full p-4 rounded-xl border-none bg-white/10 text-white placeholder-white/50 focus:ring-2 focus:ring-white outline-none"
