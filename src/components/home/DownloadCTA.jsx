  ...
  return (
    <section className="relative overflow-hidden py-16 sm:py-24 bg-[var(--kushal-white2)] select-none px-4 sm:px-6 lg:px-8">
      ...
      <div 
        ...
        style={{ background: `radial-gradient(circle, rgba(var(--kushal-primary-rgb), 0.2) 0%, transparent 75%)` }} 
      />
        ...
        >
          ...
          <div className="relative z-10 grid gap-12 lg:grid-cols-12 items-center">
            ...
            >
              ...
              >
                <Smartphone size={13} className="animate-pulse" /> Mobile Experience Available
              </span>
              ...
              >
                Book trusted services, manage custom timelines, and automate your escrow payments seamlessly. KushalApp streamlines the marketplace lifecycle for both home users and active professionals.
              </p>
              ...
              <div className="flex flex-col sm:flex-row flex-wrap justify-center lg:justify-start gap-y-3 gap-x-5 mb-10 text-neutral-600 font-semibold text-xs sm:text-sm">
                {values.map((text, idx) => (
                  <div key={idx} className="flex items-center gap-2 justify-center lg:justify-start">
                    <CheckCircle size={15} style={{ color: 'var(--kushal-base)' }} className="shrink-0" />
                    <span style={{ fontFamily: 'var(--kushal-secondary-font)' }}>{text}</span>
                  </div>
                ))}
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                ...
                >
                  ...
                  <div className="text-left leading-tight">
                    <div className="text-[10px] font-medium text-neutral-400 uppercase tracking-wider">Download on the</div>
                ...
                >
                  ...
                  <div className="text-left leading-tight">
                    <div className="text-[10px] font-medium text-neutral-400 uppercase tracking-wider">Get it on</div>
            ...
            >
              ...
              >
                ...
                >
                  <QrCode size={40} style={{ color: 'var(--kushal-heading)' }} className="stroke-[1.5]" />
                </div>
