...
const CONFIG = {
  ...
  subtitle: "KushalApp connects you with verified professionals across home maintenance, beauty & wellness, repairs, delivery, and digital services. Easily browse, book, and pay securely for all your service needs in one seamless platform.",
  ...
  features: [
    {
      ...
      description: "Access fully vetted service experts possessing certified background clearances, transparent metrics, and authentic user ratings.",
    ...
    },
    {
      ...
      description: "Coordinate single-click professional structural bookings built purely around your daily operational workflow variations.",
    ...
    },
    {
      ...
      description: "Monitor assigned service personnel transiting directly toward your registered residential or technical coordinate zones live.",
    ...
    },
    {
      ...
      description: "Execute decentralized, fully protected escrow checkouts. Safe operations built into modern end-to-end framework layers.",
                ...
                <div className="relative z-10 w-full text-left">
                  <div className="flex items-center justify-between gap-3 mb-5">
                    ...
                    <span 
                      ...
                      style={{ backgroundColor: 'var(--kushal-white4)', color: 'var(--kushal-base)' }}
                    >
                      {card.badge}
                    </span>
                  </div>
