    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        <div 
          ...
          style={{ background: `radial-gradient(circle, rgba(var(--kushal-base-rgb), 0.18) 0%, transparent 70%)` }} 
        />
        <div 
      ...
      <div className="relative z-10 w-full">
        ...
        <div className="px-4 sm:px-6 lg:px-8 mx-auto" style={{ maxWidth: 'var(--container-width)' }}>
          ...
          >
            ...
            >
              Real experiences from verified users and service providers navigating our ecosystem daily. See how KushalApp streamlines growth and convenience.
            </p>
          </motion.div>
        </div>
            ...
            {duplicatedRow2.map((item, idx) => (
              ...
              >
                <div>
                  ...
                  <div className="flex items-center gap-4 pb-4 border-b border-purple-900/30">
                    <div 
                      className="w-12 h-12 rounded-full flex items-center justify-center font-bold text-sm text-purple-950 select-none border border-purple-300/20 bg-purple-100"
                    >
                      {item.initials}
                    </div>
                    <div>
