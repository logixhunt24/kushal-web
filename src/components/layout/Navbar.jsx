...
export default function Navbar() {
  ...
  const socialLinks = {
    ...
    instagram: 'https://www.instagram.com/kushalserviceapp?igsh=MWZlc2Q0YTdxZnpxOA%3D%3D&utm_source=qr',
      ...
      <div className="w-full max-w-[1480px] mx-auto px-5 md:px-8 lg:px-10">
        ...
        <nav className="bg-[var(--kushal-white)] rounded-[var(--kushal-radius)] shadow-[var(--kushal-shadow-md)] flex items-center justify-between px-6 h-20 relative transition-all duration-300 border border-[var(--kushal-border-color)]">
          ...
          <div className="flex items-center gap-4">
            <a href="https://play.google.com/store/apps/details?id=com.kushal.app&pcampaignid=web_share" target='_blank' className="hidden lg:inline-flex bg-[var(--kushal-primary)] text-[var(--kushal-black2)] rounded-full px-6 py-3 text-sm font-bold tracking-wide transition-all duration-300 hover:translate-y-[-2px] hover:shadow-[var(--kushal-shadow-lg)] outline-none focus-visible:ring-2 focus-visible:ring-[var(--kushal-base)]">
              Download App
            </a>
          ...
          <div className="flex-1 overflow-y-auto p-5 md:p-6 space-y-5 md:space-y-6 scrollbar-thin relative z-10">
            ...
            >
              ...
              <div className="bg-[var(--kushal-white3)] border border-[var(--kushal-border-color)] p-4 rounded-[var(--kushal-radius)] space-y-3 shadow-sm transition-all duration-200 hover:border-[var(--kushal-base)]/20">
                <a href="mailto:support@kushalapp.com" className="flex items-center gap-3 group outline-none">
                  ...
                  <span className="text-xs font-semibold text-[var(--kushal-text)] group-hover:text-[var(--kushal-heading)] transition-colors duration-200">support@kushalapp.com</span>
                </a>
            ...
            >
              ...
              <div className="flex items-center gap-2">
                {[
                  { name: 'Facebook', url: socialLinks.facebook, icon: <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/> },
                  { name: 'Instagram', url: socialLinks.instagram, icon: <g><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></g> },
                  ...
                  { name: 'Youtube', url: socialLinks.youtube, icon: <path d="M22.54 6.42a2.78 2.78 0 0 0-1.95-1.96C18.88 4 12 4 12 4s-6.88 0-8.59.46A2.78 2.78 0 0 0 1.46 6.42 29.94 29.94 0 0 0 1 12a29.94 29.94 0 0 0 .46 5.58 2.78 2.78 0 0 0 1.95 1.96C5.12 20 12 20 12 20s6.88 0 8.59-.46a2.78 2.78 0 0 0 1.95-1.96A29.94 29.94 0 0 0 23 12a29.94 29.94 0 0 0-.46-5.58zM9.75 15.02V8.98L15.5 12l-5.75 3.02z"/>}
                ].map((social) => (
                  <a 
                    key={social.name}
                    href={social.url} 
          ...
          <div className="p-5 md:p-6 border-t border-[var(--kushal-border-color)] bg-[var(--kushal-white)]/95 backdrop-blur-md relative z-10 space-y-4">
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3">
                <a href="https://play.google.com/store/apps/details?id=com.kushal.app&pcampaignid=web_share" target='_blank' className="h-11 bg-[var(--kushal-base)] text-white rounded-xl text-xs font-bold inline-flex items-center justify-center gap-1.5 transition-all duration-200 hover:brightness-110 hover:-translate-y-0.5 hover:shadow-md active:translate-y-0 outline-none focus-visible:ring-2 focus-visible:ring-[var(--kushal-base)]">
                ...
                <a href="https://play.google.com/store/apps/details?id=com.kushalapp.partner&pcampaignid=web_share" target='_blank' className="h-11 border border-[var(--kushal-border-color)] text-[var(--kushal-heading)] bg-white rounded-xl text-xs font-bold inline-flex items-center justify-center transition-all duration-200 hover:border-[var(--kushal-base)] hover:text-[var(--kushal-base)] hover:-translate-y-0.5 active:translate-y-0 outline-none focus-visible:ring-2 focus-visible:ring-[var(--kushal-base)]">
