      ...
      <div className="w-full max-w-[1480px] mx-auto px-5 md:px-8 lg:px-10">
        ...
        <nav className="bg-[var(--kushal-white)] rounded-[var(--kushal-radius)] shadow-[var(--kushal-shadow-md)] flex items-center justify-between px-6 h-20 relative transition-all duration-300 border border-[var(--kushal-border-color)]">
                ...
                >
                  {({ isActive }) => (
                    <>
                      ...
                      {item !== "Home" && (
                        <span
                          className={`text-[11px] font-bold pointer-events-none ${isActive ? "text-[var(--kushal-primary)]" : "text-[var(--kushal-gray)] opacity-30"}`}
                        >
                          •
                        </span>
                      )}
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              target="_blank"
              className="hidden lg:inline-flex bg-[var(--kushal-primary)] text-[var(--kushal-black2)] rounded-full px-6 py-3 text-sm font-bold tracking-wide transition-all duration-300 hover:translate-y-[-2px] hover:shadow-[var(--kushal-shadow-lg)] outline-none focus-visible:ring-2 focus-visible:ring-[var(--kushal-base)]"
            >
              Download App
            </a>
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto p-5 md:p-6 space-y-5 md:space-y-6 scrollbar-thin relative z-10">
                ...
                {menuItems.map((item, idx) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <svg
                        className="w-3.5 h-3.5 opacity-0 -translate-x-1.5 transition-all duration-300 group-hover:opacity-100 group-hover:translate-x-0 text-[var(--kushal-base)]"
                        fill="none"
                        stroke="currentColor"
                        strokeWidth="2.5"
                        viewBox="0 0 24 24"
            ...
            >
              <span className="text-[10px] font-bold tracking-widest text-[var(--kushal-gray)] uppercase block">
                Get In Touch
              </span>
              <div className="bg-[var(--kushal-white3)] border border-[var(--kushal-border-color)] p-4 rounded-[var(--kushal-radius)] space-y-3 shadow-sm transition-all duration-200 hover:border-[var(--kushal-base)]/20">
                ...
                >
                  ...
                  <span className="text-xs font-semibold text-[var(--kushal-text)] group-hover:text-[var(--kushal-heading)] transition-colors duration-200">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-xs font-semibold text-[var(--kushal-text)]">
                    India
                  </span>
                </div>
              </div>
          ...
          <div className="p-5 md:p-6 border-t border-[var(--kushal-border-color)] bg-[var(--kushal-white)]/95 backdrop-blur-md relative z-10 space-y-4">
            ...
            >
              <div className="mb-3 flex flex-col justify-between items-center gap-0.5">
                <h5 className="text-[var(--kushal-heading)] font-black text-xs">
                  Download KushalApp
                </h5>
                <p className="text-[11px] text-[var(--kushal-text)]">
              ...
              <div className="grid grid-cols-2 gap-3">
                <a
                  href="https://play.google.com/store/apps/details?id=com.kushal.app&pcampaignid=web_share"
                  target="_blank"
                  className="h-11 bg-[var(--kushal-base)] text-white rounded-xl text-xs font-bold inline-flex items-center justify-center gap-1.5 transition-all duration-200 hover:brightness-110 hover:-translate-y-0.5 hover:shadow-md active:translate-y-0 outline-none focus-visible:ring-2 focus-visible:ring-[var(--kushal-base)]"
                >
                  <svg
                    width="14"
                    height="14"
                ...
                <a
                  ...
                  target="_blank"
                  className="h-11 border border-[var(--kushal-border-color)] text-[var(--kushal-heading)] bg-white rounded-xl text-xs font-bold inline-flex items-center justify-center transition-all duration-200 hover:border-[var(--kushal-base)] hover:text-[var(--kushal-base)] hover:-translate-y-0.5 active:translate-y-0 outline-none focus-visible:ring-2 focus-visible:ring-[var(--kushal-base)]"
                >
