...
const steps = [
  {
    ...
    description:
      "Sign up as a service provider by submitting your basic details and complete your profile verification to get started.",
  },
  {
    icon: Briefcase,
    step: "02",
    ...
    description:
      "List your services, define your pricing, and showcase your skills. You control how much you charge with no platform interference.",
  },
  {
    icon: Handshake,
    step: "03",
    ...
    description:
      "Receive direct inquiries, negotiate transparently with customers, and grow your income with our zero commission model.",
  },
];
